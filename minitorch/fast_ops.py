...
def tensor_map(
    ...
    * When `out` and `in` are stride-aligned, avoid indexing
    ...
    return njit(parallel=True,boundscheck=False)(_map)  # type: ignore
...
def tensor_zip(
    ...
    * When `out`, `a`, `b` are stride-aligned, avoid indexing
    ...
    return njit(parallel=True,boundscheck=False)(_zip)  # type: ignore
...
def tensor_reduce(
    ...
    * Inner-loop should not call any functions or write non-local variables
    ...
    return njit(parallel=True,boundscheck=False)(_reduce)  # type: ignore
